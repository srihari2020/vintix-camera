...
class CameraProfileUniformHandles(program: ShaderProgram) {
    ...
    private val uGreenMagentaShift = program.getUniformLocation("uGreenMagentaShift")
    ...
    private val uMosquitoNoise = program.getUniformLocation("uMosquitoNoise")
    ...
    private val uBloomIntensity = program.getUniformLocation("uBloomIntensity")
    ...
    fun upload(
        ...
        if (uGreenMagentaShift >= 0) GLES20.glUniform1f(uGreenMagentaShift, profile.greenMagentaShift)
        ...
        if (uMosquitoNoise >= 0) GLES20.glUniform1f(uMosquitoNoise, profile.mosquitoNoise)
        ...
        if (uBloomIntensity >= 0) GLES20.glUniform1f(uBloomIntensity, profile.bloomIntensity)
